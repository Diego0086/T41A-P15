...
--Crear una función que valide si un correo electrónico contiene '@'.
...
--Crear una función que devuelva los productos con stock menor a un valor dado.
...
--Crear una función que reciba una fecha y devuelva el día de la semana.
...
--Crear una función que cuente cuántos empleados hay en un departamento.
